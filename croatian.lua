...
local L = LANG.CreateLanguage("Hrvatski")
...
L.traitor_upper    = "IZDAJNIK"
L.detective_upper  = "DETEKTIV"
L.innocent_upper   = "NEVIN"

L.last_words = "Zadnje riječi"

L.terrorists = "Teroristi"
L.spectators = "Promatrači"

--- Round status messages
L.round_minplayers = "Nedovoljno igrača za početak nove runde..."
L.round_voting     = "Glasanje u tijeku, nova runda odgođena za {num} sekundi..."
L.round_begintime  = "Nova runda počinje za {num} sekundi. Pripremite se."
L.round_selected   = "Izdajnici su izabrani."
L.round_started    = "Runda je započela!"
L.round_restart    = "Administrator je prisilno poništio rundu."

L.round_traitors_one  = "Izdajnik, nemate saveznika."
L.round_traitors_more = "Izdajnik, ovo su vaši saveznici: {names}"

L.win_time         = "Vrijeme isteklo. Izdajnici su izgubili."
L.win_traitor      = "Izdajnici su pobijedili!"
L.win_innocent     = "Izdajnici su poraženi!"
L.win_showreport   = "Pogledajmo izvještaj o rundi na {num} sekundi."

L.limit_round      = "Ograničenje broja rundi dosegnuto. Učitavam mapu {mapname}."
L.limit_time       = "Vremensko ograničenje dosegnuto. Učitavam mapu {mapname}."
L.limit_left       = "Preostalo {num} rundi ili {time} minuta do promjene mape na {mapname}."

--- Credit awards
L.credit_det_all   = "Detektivi, nagrađeni ste sa {num} kredita za opremu zbog vaše performance."
L.credit_tr_all    = "Izdajnici, nagrađeni ste sa {num} kredita za opremu zbog vaše performance."

L.credit_kill      = "Dobili ste {num} kredita zbog ubojstva {role}."

--- Karma
L.karma_dmg_full   = "Vaša Karma iznosi {amount}, stoga ovu rundu radite punu količinu štete!"
L.karma_dmg_other  = "Vaša Karma iznosi {amount}, stoga je količina štete koju radite umanjena za {num}%"

--- Body identification messages
L.body_found       = "{finder} je pronašao tijelo {victim}. {role}"

-- The {role} in body_found will be replaced by one of the following:
L.body_found_t     = "Osoba je bila izdajnik!"
L.body_found_d     = "Osoba je bila detektiv."
L.body_found_i     = "Osoba je bila nevina."

L.body_confirm     = "{finder} confirmed the death of {victim}."

L.body_call        = "{player} je pozvao detektiva do {victim}ovog tijela!"
L.body_call_error  = "Morate potvrditi smrt ovog igrača prije pozivanja detektiva!"

L.body_burning     = "Jao! Ovo tijelo gori!"
L.body_credits     = "Pronašli ste {num} kredita na tijelu!"
...
L.equip_title     = "Oprema"
L.equip_tabtitle  = "Narudžba opreme"

L.equip_status    = "Status narudžbe"
L.equip_cost      = "Preostalo vam je {num} kredita."
L.equip_help_cost = "Svaki komad opreme koji kupite košta 1kredit."

L.equip_help_carry = "Možete kupiti samo stvari za koje imate mjesta."
L.equip_carry      = "Možete držati ovu opremu."
L.equip_carry_own  = "Već držite ovaj komad opreme."
L.equip_carry_slot = "Već imate oružje na poziciji {slot}."

L.equip_help_stock = "Neke predmete možete kupiti samo jednom u rundi."
L.equip_stock_deny = "Ovaj predmet je izvan zalihe."
L.equip_stock_ok   = "Ovaj predmet je na zalihi."

L.equip_custom     = "Predmet dostupan samo na ovom serveru."

L.equip_spec_name  = "Ime"
L.equip_spec_type  = "Vrsta"
L.equip_spec_desc  = "Opis"

L.equip_confirm    = "Kupi opremu"

-- Disguiser tab in equipment menu
L.disg_name      = "Prikrivač"
L.disg_menutitle = "Kontrola prikrivača"
L.disg_not_owned = "Nemate prikrivač!"
L.disg_enable    = "Uključi prikrivač"

L.disg_help1     = "Dok je prikrivač uključen, vaše ime, život i karma nisu prikazani osobama koje vas gledaju. Dodatno, detektivski radar vas ne detektira."
L.disg_help2     = "Pritisnite Numpad Enter za paljenje ili gašenje prikrivača bez korištenja izbornika. Također možete pomoću konzole dodijeliti akciju 'ttt_toggle_disguise' na neku drugu tipku."

-- Radar tab in equipment menu
L.radar_name      = "Radar"
L.radar_menutitle = "Kontrola radara"
L.radar_not_owned = "Nemate radar!"
L.radar_scan      = "Skeniraj"
L.radar_auto      = "Automatsko ponavljanje skeniranja"
L.radar_help      = "Rezultat skeniranja prikazat će se na {num} sekundi, nakon čega možete iskoristiti radar ponovo."
L.radar_charging  = "Vaš radar još nije spreman za skeniranje!"

-- Transfer tab in equipment menu
L.xfer_name       = "Krediti"
L.xfer_menutitle  = "Prijenos kredita"
L.xfer_no_credits = "Nemate kredita za prenijeti!"
L.xfer_send       = "Pošalji kredit"
L.xfer_help       = "Možete slati kredite samo igračima u vašem timu."

L.xfer_no_recip   = "Neispravan primatelj, prijenos kredita obustavljen."
L.xfer_no_credits = "Nedovoljno kredita za prijenos."
L.xfer_success    = "Uspješno izvršen prijenos kredita igraču {player}."
L.xfer_received   = "{player} vam je poslao {num} kredita."

-- Radio tab in equipment menu
L.radio_name      = "Radio"
L.radio_help      = "Kliknite na tipku u izborniku da pustite taj zvuk na vašem radiu."
L.radio_notplaced = "Morate postaviti radio da biste pomoću njega mogli puštati zvuk."

-- Radio soundboard buttons
L.radio_button_scream  = "Vrisak"
L.radio_button_expl    = "Eksplozija"
L.radio_button_pistol  = "Five-SeveN" --"Pištolj"
L.radio_button_m16     = "M16"
L.radio_button_deagle  = "Desert Eagle"
L.radio_button_mac10   = "Mac-10"
L.radio_button_shotgun = "M1014" --"Sačmarica"
L.radio_button_rifle   = "SSG08" --"Snajper"
L.radio_button_huge    = "M249"
L.radio_button_c4      = "C4"
L.radio_button_burn    = "Vatra"
L.radio_button_steps   = "Koraci"


-- Intro screen shown after joining
L.intro_help     = "Ako niste već igrali, pritisnite F1za uputstva!"

-- Radiocommands/quickchat
L.quick_title   = "Tipke za brzi chat"

L.quick_yes     = "Da."
L.quick_no      = "Ne."
L.quick_help    = "Upomoć!"
L.quick_imwith  = "Ja sam sa {player}."
L.quick_see     = "Vidim {player}."
L.quick_suspect = "{player} se sumnjivo ponaša."
L.quick_traitor = "{player} je izdajnik!"
L.quick_inno    = "{player} je nevin."
L.quick_check   = "Je li još itko živ?"

-- {player} in the quickchat text normally becomes a player nickname, but can
-- also be one of the below.  Keep these lowercase.
L.quick_nobody    = "nitko"
L.quick_disg      = "prikrivena osoba"
L.quick_corpse    = "neidentificirano tijelo"
L.quick_corpse_id = "tijelo igrača {player}"
...
L.sipistol_desc   = [[
A powerful high capacity pistol.

Has a built-in compensator to reduce recoil.

Can one shot to the head up close.]]
...
-- HUD
L.hud_needplayers = "NEDOVOLJNO IGRAČA ZA POČETAK RUNDE"
L.hud_newround = "RUNDA POČINJE ZA "
L.hud_endround = "RUNDA ZAVRŠAVA ZA "

L.hud_perspective = "Promijeni Perspektivu"
L.hud_nextplayer = "Sljedeći Igrač"
L.hud_resetcamera = "Resetirajte Kameru"

-- Weapons
L.melee_fists = "Šake"
L.melee_axe = "Sjekira"
L.melee_crowbar = "Pajser"
L.melee_pan = "Tava"
L.melee_sledge = "Malj"

L.nade_conf_name = "M67 Discombobulator"
L.nade_flash_name = "M84 Flashbang"
L.nade_fire_name = "AN/M14 Incendiary" -- Zapaljiva
L.nade_smoke_name = "Model 5210 Smoke" -- Dimna

-- Calibres
L.search_calibre = "Prostrijelne rane u tijelu upućuju da je upucan mecima kalibra {weapon}."

L.magazine_empty = "Prazan šanžer oružja {weapon}."
L.magazine_calibre = "Ovaj šanžer oružja {weapon} sadrži {rounds} metaka kalibra {calibre}."
