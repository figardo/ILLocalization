...
local L = LANG.CreateLanguage("Ελληνικά")

--- General text used in various places
L.traitor    = "Προδότης"
L.detective  = "Ντεντεκτίβ"
L.innocent   = "Αθώος"

L.traitor_upper    = "ΠΡΟΔΌΤΗΣ"
L.detective_upper  = "ΝΤΕΝΤΕΚΤΊΒ"
L.innocent_upper   = "ΑΘΏΟΣ"
...
-- HUD
L.hud_needplayers = "ΠΕΡΙΜΕΝΟΝΤΑΣ ΠΑΙΚΤΕΣ"
L.hud_newround = "Ο ΓΥΡΟΣ ΞΕΚΙΝΑΕΙ ΣΕ "
L.hud_endround = "Ο ΓΥΡΟΣ ΤΕΛΕΙΩΝΕΙ ΣΕ "

-- Weapons
L.melee_fists = "Γροθιές"
L.melee_axe = "Τσεκούρι"
L.melee_crowbar = "Λοστός"
L.melee_pan = "Τηγάνι"
L.melee_sledge = "Βαριοπούλα"
