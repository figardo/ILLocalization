...
L.traitor_upper    = "ПРЕДАТЕЛЬ"
L.detective_upper  = "ДЕТЕКТИВ"
L.innocent_upper   = "НЕВИНОВНЫЙ"
...
L.ammo_pistol     = "ПАТРОНЫ ДЛЯ ПИСТОЛЕТНЫЕ"
L.ammo_airboatgun = "ПАТРОНЫ ДЛЯ ПУЛЕМЁТ"
L.ammo_smg1       = "ПАТРОНЫ ДЛЯ ВИНТОВКИ"
L.ammo_buckshot   = "ПАТРОНЫ ДЛЯ ДРОБОВИКА"
L.ammo_357        = "ПАТРОНЫ ДЛЯ СНАЙПЕРСКАЯ"
L.ammo_alyxgun    = "ПАТРОНЫ ДЛЯ МАГНУМ"
L.ammo_ar2altfire = "ПАТРОНЫ ДЛЯ РАКЕТНИЦЫ"
L.ammo_gravity    = "ПАТРОНЫ ДЛЯ ПОЛТЕРГЕЙСТА"
L.ammo_spycam     = "ШПИОНСКАЯ КАМЕРА"
L.ammo_dart     = "ДРОТИК С ТРАНКВИЛИЗАТОРОМ"
...
-- HUD
L.hud_needplayers = "ЖДЕМ ИГРОКОВ"
L.hud_newround = "РАУНД НАЧИНАЕТСЯ ЗА "
L.hud_endround = "РАУНД ЗАКАНЧИВАЕТСЯ ЗА "

-- Weapons
L.melee_fists = "Кулаки"
L.melee_axe = "Топор"
L.melee_crowbar = "Аншпуг"
L.melee_pan = "Сковорода"
L.melee_sledge = "Кувалда"

L.weapon_akm = "АКМ"
L.weapon_an94 = "АН94 «Абака́н»"
L.weapon_bizon = "ПП-19 «Бизон»"

L.nade_bee_name = "Пчелиная граната"
L.nade_conf_name = "M67 толчок граната"
L.nade_flash_name = "M84 Световая граната"
L.nade_holy_name = "святая граната"
L.nade_fire_name = "AN/M14 Зажигательная граната"
L.nade_smoke_name = "модель 5210 Дымовая граната"

-- Calibres
L.search_calibre = "раны на теле указывают на то, что в них стреляли патронами {weapon}."

L.cal_9x18 = "9x18мм Макаров"
L.cal_9x19 = "9x19мм Парабеллум"
L.cal_357sig = ".357 SIG"
L.cal_40sw = ".40 S&W"
L.cal_45acp = ".45 ACP"
L.cal_357mag = ".357 Magnum"
L.cal_50ae = ".50 Экшн Экспресс"

L.cal_12gbuck = "Картечь 12-го калибра"

L.cal_46x30 = "HK 4.6x30мм"
L.cal_57x28 = "FN 5.7x28мм"

L.cal_545x39 = "5.45x39мм"
L.cal_556x45 = "5.56x45мм НАТО"
L.cal_762x39 = "7.62x39мм советский"
L.cal_762x51 = "7.62x51мм НАТО"

L.cal_308win = ".308 Винчестер"
L.cal_338lm = ".338 Lapua Magnum"
L.cal_50bmg = ".50 BMG"

-- Firemodes
L.fm_melee_name = "РУКОПАШНАЯ"
L.fm_carry_name = "НЕСТИ"
L.fm_semi_name = "ПОЛУ"
L.fm_auto_name = "АВТО"
L.fm_dact_name = "DACT"
L.fm_burst_name = "%dBST"
L.fm_plant_name = "МЕСТО"

-- Equipment

-- Bait & Switch
L.baitswitch_name = "Приманка и Радио"
L.baitswitch_desc = [[
...
-- Binoculars
L.binoc_name      = "Тепловизионные Бинокль"
L.binoc_desc      = [[
